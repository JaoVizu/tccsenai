      ...
      <div class="box box-success">
        ...
        <form action="../update/updateCategoria.php" id="formCat" method="post">
            <?php
                ...
                $pegaCat = mysqli_query($conn, "SELECT * FROM CATEGORIA WHERE CODCATEGORIA = '$cod'");
                foreach($pegaCat as $rowCatiguria){
            ?>
            <div class="row">
                <div class="col-md-3">
                    <label for="">Código Categoria</label> <br/>
                    <input type="text" value="<?php echo $rowCatiguria['CodCategoria']?>" name="codCat" class="form-control" readonly> <br/>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                    <label for="">Nome Categoria</label><br/>
                    <input type="text" value="<?php echo $rowCatiguria['NomeCategoria']?>" name="nomeCat" class="form-control">
                </div>
            </div>
            <br/>
            <input type="submit" class="btn btn-primary mb-5 ml-5" value="Alterar">
